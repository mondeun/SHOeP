<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="OrderSummary.aspx.cs" Inherits="SHOeP.Order.Order" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div>
        ...
        <asp:Label ID="Name" runat="server" Text="Krisztina Barta"></asp:Label><br />
    ...
    <div>
        ...
        <asp:Button ID="Confirmation" runat="server" OnClick="ConfirmationClick" Text="Bekräfta"></asp:Button>
    </div>
    <br />
</asp:Content>
